...
alter table commande add constraint fk_comm_prod FOREIGN KEY(id_prod) REFERENCES produit(id);
alter table commande add constraint fk_comm_user FOREIGN KEY(id_user) REFERENCES user(id_user);

alter table favoris add constraint fk_fav_user FOREIGN KEY(id_user) REFERENCES user(id_user);
alter table favoris add constraint fk_fav_prod FOREIGN KEY(id_prod) REFERENCES produit(id);
